                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="sign-side-block">
                                        <h1 class="login-title">Welcome to Creative Bucket</h1>
                                        <p> Sign Up </p>
                                        <div class="space20"></div>
                                            {!! Form::open(array('route' => 'users.store','action'=>'AccountsController@doLogIn', 'method' => 'post')) !!}
                                        ...
                                        <!-- <form id="form-validation" action="" method="get" accept-charset="utf-8"> -->
                                            ...
                                            <div>
                                                <p> Already have an account, <a href="signin.html" class="register-link"> Sign in here. </a> </p>
                                            </div>
                                        </form>
                                    </div>
                                </div>
